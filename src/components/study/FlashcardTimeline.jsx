    ...
    <FlashcardFlip
      ...
      front={
        <div className="space-y-2 text-center">
          <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-orange-500/20 text-orange-400">
        ...
        <div className="w-full text-left">
          {card.steps && card.steps.length > 0 ? (
            <div className="relative pl-4">
              <div className="absolute left-1.5 top-1 bottom-1 w-px bg-orange-500/30" />
              {card.steps.map((step, i) => (
                <div key={i} className="relative mb-3 flex items-start gap-3 text-xs last:mb-0">
                  <div className="absolute -left-4 mt-0.5 h-3 w-3 rounded-full border-2 border-orange-500 bg-slate-900" />
